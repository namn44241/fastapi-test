...
class Container(containers.DeclarativeContainer):
    ...
    pet_repository = providers.Factory(PetRepository, session_factory=db.provided.session)
    ...
    pet_service = providers.Factory(PetService, pet_repository=pet_repository)
